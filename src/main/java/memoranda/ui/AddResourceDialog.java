...
public class AddResourceDialog extends JDialog {
    ...
    void jbInit() throws Exception {
        ...
        //all uses of layoutGridBag in this file.
        layoutGridBag(localFileRB,0,0);
        layoutGridBag(projectFileCB,2,0);
        
        jLabel1.setText(Local.getString("Path")+": ");
        layoutGridBag(jLabel1,0,1);
        ...
        layoutGridBag(inetShortcutRB,0,2);
        jLabel2.setText(Local.getString("URL")+":  ");
        layoutGridBag(jLabel2,0,3);
     ...
     * TASK 2-1 SMELL WITHIN A CLASS
     * Duplicate code
     * Sets up the GridBag constraints for the passed component
     * 
     * @param component
     * @param x
     * @param y
     */
    private void layoutGridBag(Component component, int x, int y) {
        gbc = new GridBagConstraints();
        gbc.gridx = x; gbc.gridy = y;
        gbc.insets = new Insets(5, 5, 5, 5);
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        areaPanel.add(component, gbc); 
    }
