...
public class DailyItemsPanel extends JPanel {
    ...
    void jbInit() throws Exception {
        ...
        CurrentProject.addProjectListener(new IProjectListener() {
            public void projectChange(ProjectData projectData) {
...
//            	Util.debug("current project is " + CurrentProject.get().getTitle());
            	...
            	currentProjectChanged(projectData.getProject(), projectData.getNotelist(), 
            	        projectData.getTasklist(), projectData.getResources());
            }
